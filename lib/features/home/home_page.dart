        ...
        SliverPadding(
          ...
          sliver: SliverList(
            delegate: SliverChildListDelegate([
              HeroCard(
                compact: true,
                title: 'Günaydın, ${appRepository.student.name}',
                subtitle: '',
                badges: const [
              ...
              const SectionHeader(
                ...
                subtitle: 'Takvimine gore siradaki akademik akışın',
              ),
                      ...
                      children: [
                        Container(
                          ...
                          decoration: BoxDecoration(
                            color: AppColors.sunrise.withValues(alpha: 0.16),
              ...
              const SectionHeader(
                title: 'Son Duyurular',
                subtitle: 'Üniversite, fakülte ve ders kaynakli güncellemeler',
              ),
              const SizedBox(height: 16),
